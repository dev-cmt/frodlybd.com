...
<head>
    ...
    <style>
        ...
        .search-box input {
            ...
            border: 1px solid #2e6cfa;
            padding: 20px 20px;
            box-shadow: 2px 8px 12px 5px rgba(0, 0, 0, 0.05);
        }
        ...
        .stat-box {
            ...
            padding: 20px;
            border-radius: 5px;
            border-bottom: #1677ff 4px solid;
            box-shadow: 2px 8px 12px 5px rgba(0, 0, 0, 0.05);
            transition: all 0.3s ease;
        }
...
<body>
        ...
        <div class="row justify-content-center my-5">
            <div class="col-md-8">
                <div class="input-group search-box">
                    ...
                    <input type="text" id="phoneInput" class="form-control" placeholder="01XXXXXXXXXX"
    ...
    <div style="width:100%; height:2px; background:#ddd; margin:20px 0; position:relative; overflow:hidden;">
        <span
            style="display:inline-block; width:35px; height:2px; background:#007bff; position:absolute; top:0px; left:0; animation: slideLR 8s infinite ease-in-out;"></span>
        <style>
            @keyframes slideLR {
                0% {
                    left: 0;
            ...
            $('#submit-btn').click(function(e) {
                ...
                $.get('/check', {
                    ...
                    let riskData = totalSummary.successRate < 50 ? {
                        ...
                        label: totalSummary.successRate < 90 ? 'Great Customer' :
                            'Excellent Customer',
                        bg: '#e0f7fa',
                        border: '#00b606ff',
                        color: '#00b606ff'
                    ...
                    $('#courierTableBody').html(Object.entries(Summaries).map(([courier, data]) => {
                        let cancelRate = data.total > 0 ? ((data.cancel / data.total) *
                            100).toFixed(1) : '0.0';
                        return `<tr>
                ...
                chartInstance = new Chart(ctx, {
                    ...
                    data: {
                        datasets: [{
                            ...
                            backgroundColor: [
                                finalValue < 50 ? '#e63946' : finalValue < 75 ? '#ffb703' :
                                '#00b606ff',
                                '#f1f1f1'
                            ],
                            borderWidth: 0
