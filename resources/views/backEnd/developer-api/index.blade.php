...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-xl-4 mb-4">
            <div class="card custom-card h-100">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.developer-api.generate-token') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            ...
                            <div class="d-flex gap-2">
                                <button type="button" class="btn btn-sm btn-outline-primary"
                                    onclick="copyText('#api-token')">Copy Token</button>
                    ...
                    <div class="mt-4">
                        ...
                        <div id="list-example" class="list-group">
                            <a class="list-group-item list-group-item-action" href="#base-url">Base URL</a>
                            <a class="list-group-item list-group-item-action" href="#check-courier">Check Courier</a>
                            <a class="list-group-item list-group-item-action" href="#php-curl">PHP - cURL</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-8">
            <div data-bs-spy="scroll" data-bs-target="#list-example" data-bs-smooth-scroll="true" tabindex="0"
                ...
                {{-- Base URL --}}
                <div class="card api-card" id="base-url">
                    <div class="card-header api-card-header">1️⃣ Base URL</div>
                    <div class="card-body">
                ...
                <div class="card api-card" id="check-courier">
                    <div class="card-header api-card-header">2️⃣ Check Courier</div>
                    <div class="card-body">
    ...
    "data": {
        ...
        "totalSummary": {"total": 33,"success": 30,"cancel": 3,"successRate": 91,"cancelRate": 9}
                ...
                {{-- PHP - cURL --}}
                <div class="card api-card" id="php-curl">
                    <div class="card-header api-card-header">3️⃣ PHP - cURL</div>
                    <div class="card-body">
                        <div class="code-block">
                            <button class="copy-btn" onclick="copyCode(this)">Copy</button>
                            <pre>
...
curl_setopt_array($curl, [
    CURLOPT_URL => 'https://frodlybd.com/api/check-courier',
    ...
    CURLOPT_HTTPHEADER => ['X-API-TOKEN: XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX', 'Content-Type: application/json'],
]);
        ...
        <div id="liveToast" class="toast align-items-center text-white bg-primary border-0" role="alert"
            ...
            <div class="d-flex flex-column">
                <div class="toast-header text-white">
                    <img src="{{ asset($settings ? $settings->logo : '') }}" class="rounded me-2" width="20"
                        height="20" alt="...">
